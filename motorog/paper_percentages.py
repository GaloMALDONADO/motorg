...
viewer.setVisibility(participantName+"1/floor", "OFF")
...
#Takeoff
viewer.display(x1[1],robot1.name)
viewer.display(x1[40], robot1.name)
viewer.display(x1[70], robot1.name)
viewer.display(x1[99], robot1.name)

#Landing
viewer.display(x2[4],robot1.name)
viewer.display(x2[13], robot1.name)
viewer.display(x2[20], robot1.name)
viewer.display(x2[40], robot1.name)
viewer.display(x2[99], robot1.name)
