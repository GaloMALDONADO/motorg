...
class CentroidalMomentum(Plot):
    ...
    def plotMomentumRateLanding(self):
        ...
        #plt.title('Landing: torque in sagittal plane')
        ax.plot(-task_hat[:,0],'-r', linewidth=3.0)
        ax.plot(task_hat[:,2],'-g', linewidth=3.0)
