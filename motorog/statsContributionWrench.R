...
# MEANS
# Linear Momentum x
jump.means.x <- structure(list('pelvis'=c(meanDataLMx[1,1], meanDataLMx[2,1], meanDataLMx[3,1], meanDataLMx[4,1]),
...
# Linear Momentum Y
jump.means.y <- structure(list('pelvis'=c(meanDataLMy[1,1], meanDataLMy[2,1], meanDataLMy[3,1], meanDataLMy[4,1]),
...
# Linear Momentum Z
jump.means.z <- structure(list('pelvis'=c(meanDataLMz[1,1], meanDataLMz[2,1], meanDataLMz[3,1], meanDataLMz[4,1]),
...
# 
# Angular Momentum x
jump.means.xx <- structure(list('pelvis'=c(meanDataAMx[1,1], meanDataAMx[2,1], meanDataAMx[3,1], meanDataAMx[4,1]),
...
# Angular Momentum Y
jump.means.yy <- structure(list('pelvis'=c(meanDataAMy[1,1], meanDataAMy[2,1], meanDataAMy[3,1], meanDataAMy[4,1]),
...
# Angular Momentum Z
jump.means.zz <- structure(list('pelvis'=c(meanDataAMz[1,1], meanDataAMz[2,1], meanDataAMz[3,1], meanDataAMz[4,1]),
...
barx = barplot(as.matrix(jump.means.z), main="Jump Linear Momentum Vertical",
               ylab=expression(kg %.% m %.% s^-1 %.% BM^-1),
               xlim=c(0,30),ylim=c(0,0.4),
               col=c("red","green","blue","yellow"),
               legend = c( "1%","40%", "70%", "100%"),  las=2, cex.names = 1) #beside=TRUE,xlab="joint",
rm(op)
...
# 
op = par(mar=c(8,5,4,2)) # c(bottom, left, top, right) which gives the number of lines of margin
barx = barplot(as.matrix(jump.means.xx), main="Jump Angular Momentum around Medial Lateral Axis",
...
takeoff.means.x <- structure(list(
  'back'=c(meanDataLMx[1,12], meanDataLMx[2,12], meanDataLMx[3,12], meanDataLMx[4,12]),
...
barx = barplot(as.matrix(-takeoff.means.x), main="Take-off Linear Momentum0 (A-P)",
               ylab=expression(kg %.% m %.% s^-1 %.% BW^-1),
               xlim=c(0,35),ylim=c(-0,0.06),
               col=c("red","green","blue","yellow"),
               legend = c( "1%","40%", "70%", "100%"),  
               las=2, cex.names = 1, beside=TRUE,args.legend = list(x=25,horiz=TRUE)) #beside=TRUE,xlab="joint",
rm(op)


xx=as.matrix(-takeoff.means.x)
er=as.matrix(takeoff.stds.x)
erci=as.matrix(takeoff.ci.x)
...
takeoff.means.z <- structure(list(
  'back'=c(meanDataLMz[1,12], meanDataLMz[2,12], meanDataLMz[3,12], meanDataLMz[4,12]),
...
op = par(mar=c(4,5,4,2)) # c(bottom, left, top, right) which gives the number of lines of margin
barx = barplot(as.matrix(takeoff.means.z), main="Take-off Linear Momentum0 (V)",
               ylab=expression(kg %.% m %.% s^-1 %.% BW^-1),
               xlim=c(0,35),ylim=c(-0.002,0.06),
               col=c("red","green","blue","yellow"),
               legend = c( "1%","40%", "70%", "100%"),  las=2, cex.names = 1, beside=TRUE) #beside=TRUE,xlab="joint",
rm(op)


xx=as.matrix(takeoff.means.z)
er=as.matrix(takeoff.stds.z)
erci=as.matrix(takeoff.ci.z)
arrows(barx,xx+erci, barx,xx, angle=90, code=3, length=0.05)
arrows(barx,xx-erci, barx,xx, angle=90, code=3, length=0.05)
...
op = par(mar=c(4,5,4,2)) # c(bottom, left, top, right) which gives the number of lines of margin
barx = barplot(as.matrix(-takeoff.means.x), main="Take-off Linear Momentum (AP)",
               ylab=expression(kg %.% m %.% s^-1 %.% BW^-1),
               xlim=c(0,35),ylim=c(-0.002,0.06),
...
simp_names = list('1%','40%','70%','100%')
takeoff.means.z <- structure(list(
  '1%'= c(meanDataLMz[1,12], meanDataLMz[1,1], meanDataLMz[1,13], meanDataLMz[1,14], meanDataLMz[1,20]),
  '40%' =c(meanDataLMz[2,12], meanDataLMz[2,1], meanDataLMz[2,13], meanDataLMz[2,14], meanDataLMz[2,20]),
  '70%' = c(meanDataLMz[3,12], meanDataLMz[3,1], meanDataLMz[3,13], meanDataLMz[3,14], meanDataLMz[3,20]),
...
#
takeoff.stds.z <- structure(list(
  '1%'= c(stdDataLMz[1,12], stdDataLMz[1,1], stdDataLMz[1,13], stdDataLMz[1,14], stdDataLMz[1,20]),
  '40%' =c(stdDataLMz[2,12], stdDataLMz[2,1], stdDataLMz[2,13], stdDataLMz[2,14], stdDataLMz[2,20]),
  '70%' = c(stdDataLMz[3,12], stdDataLMz[3,1], stdDataLMz[3,13], stdDataLMz[3,14], stdDataLMz[3,20]),
...
k=t/sqrt(nparticipants)
takeoff.ci.z <- structure(list(
  '1%'= c(k*stdDataLMz[1,12], k*stdDataLMz[1,1], k*stdDataLMz[1,13], k*stdDataLMz[1,14], k*stdDataLMz[1,20]),
  '40%' =c(k*stdDataLMz[2,12], k*stdDataLMz[2,1], k*stdDataLMz[2,13], k*stdDataLMz[2,14], k*stdDataLMz[2,20]),
  '70%' = c(k*stdDataLMz[3,12], k*stdDataLMz[3,1], k*stdDataLMz[3,13], k*stdDataLMz[3,14], k*stdDataLMz[3,20]),
...
## sagital torque
simp_names = list('1%','40%','70%','100%')
takeoff.means.yy <- structure(list(
  '1%'= c(meanDataAMy[1,12], meanDataAMy[1,1], meanDataAMy[1,2], meanDataAMy[1,7], meanDataAMy[1,13], meanDataAMy[1,3], meanDataAMy[1,8]),
  '40%' =c(meanDataAMy[2,12], meanDataAMy[2,1], meanDataAMy[2,2], meanDataAMy[2,7], meanDataAMy[2,13], meanDataAMy[2,3], meanDataAMy[2,8]),
  '70%' = c(meanDataAMy[3,12], meanDataAMy[3,1], meanDataAMy[3,2], meanDataAMy[3,7], meanDataAMy[3,13], meanDataAMy[3,3], meanDataAMy[3,8]),
...
#
takeoff.stds.yy <- structure(list(
  '1%'= c(stdDataAMy[1,12], stdDataAMy[1,1], stdDataAMy[1,2], stdDataAMy[1,7], stdDataAMy[1,13], stdDataAMy[1,3], stdDataAMy[1,8]),
  '40%' =c(stdDataAMy[2,12], stdDataAMy[2,1], stdDataAMy[2,2], stdDataAMy[2,7], stdDataAMy[2,13], stdDataAMy[2,3], stdDataAMy[2,8]),
  '70%' = c(stdDataAMy[3,12], stdDataAMy[3,1], stdDataAMy[3,2], stdDataAMy[3,7], stdDataAMy[3,13], stdDataAMy[3,3], stdDataAMy[3,8]),
...
k=t/sqrt(nparticipants)
takeoff.ci.yy <- structure(list(
  '1%'= c(k*stdDataAMy[1,12], k*stdDataAMy[1,1], k*stdDataAMy[1,2], k*stdDataAMy[1,7], k*stdDataAMy[1,13], k*stdDataAMy[1,3], k*stdDataAMy[1,8]),
  '40%' =c(k*stdDataAMy[2,12], k*stdDataAMy[2,1], k*stdDataAMy[2,2], k*stdDataAMy[2,7], k*stdDataAMy[2,13], k*stdDataAMy[2,3], k*stdDataAMy[2,8]),
  '70%' = c(k*stdDataAMy[3,12], k*stdDataAMy[3,1], k*stdDataAMy[3,2], k*stdDataAMy[3,7], k*stdDataAMy[3,13], k*stdDataAMy[3,3], k*stdDataAMy[3,8]),
