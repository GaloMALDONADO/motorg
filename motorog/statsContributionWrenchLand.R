...
names<- c('pelvis','thigh_r','leg_r','foot_flex_r','foot_r','toes_r','thigh_l','leg_l','foot_flex_l','foot_l',
          'toes_l','back','head','arm_r','elbow_r','elbow_rot_r','hand_deviation_r','hand_flex_r','fingers_r',
          'arm_l','elbow_l','elbow_rot_l','hand_deviation_l','hand_flex_l','fingers_l')
...
land.means.x <- structure(list('pelvis'=c(meanDataLMx[1,1], meanDataLMx[2,1], meanDataLMx[3,1], meanDataLMx[4,1]),
                               ...
                               'foot_flex_r'=c(meanDataLMx[1,4], meanDataLMx[2,4], meanDataLMx[3,4], meanDataLMx[4,4]),
                               ...
                               'foot_flex_l'=c(meanDataLMx[1,9], meanDataLMx[2,9], meanDataLMx[3,9], meanDataLMx[4,9]),
                               ...
                               'elbow_rot_r'=c(meanDataLMx[1,16], meanDataLMx[2,16], meanDataLMx[3,16], meanDataLMx[4,16]),
                               'hand_deviation_r'=c(meanDataLMx[1,17], meanDataLMx[2,17], meanDataLMx[3,17], meanDataLMx[4,17]),
                               'hand_flex_r'=c(meanDataLMx[1,18], meanDataLMx[2,18], meanDataLMx[3,18], meanDataLMx[4,18]),
                               ...
                               'elbow_rot_l'=c(meanDataLMx[1,22], meanDataLMx[2,22], meanDataLMx[3,22], meanDataLMx[4,22]),
                               'hand_deviation_l'=c(meanDataLMx[1,23], meanDataLMx[2,23], meanDataLMx[3,23], meanDataLMx[4,23]),
                               'hand_flex_l'=c(meanDataLMx[1,24], meanDataLMx[2,24], meanDataLMx[3,24], meanDataLMx[4,24]),
...
land.means.y <- structure(list('pelvis'=c(meanDataLMy[1,1], meanDataLMy[2,1], meanDataLMy[3,1], meanDataLMy[4,1]),
                               ...
                               'foot_flex_r'=c(meanDataLMy[1,4], meanDataLMy[2,4], meanDataLMy[3,4], meanDataLMy[4,4]),
                               ...
                               'foot_flex_l'=c(meanDataLMy[1,9], meanDataLMy[2,9], meanDataLMy[3,9], meanDataLMy[4,9]),
                               ...
                               'elbow_rot_r'=c(meanDataLMy[1,16], meanDataLMy[2,16], meanDataLMy[3,16], meanDataLMy[4,16]),
                               'hand_deviation_r'=c(meanDataLMy[1,17], meanDataLMy[2,17], meanDataLMy[3,17], meanDataLMy[4,17]),
                               'hand_flex_r'=c(meanDataLMy[1,18], meanDataLMy[2,18], meanDataLMy[3,18], meanDataLMy[4,18]),
                               ...
                               'elbow_rot_l'=c(meanDataLMy[1,22], meanDataLMy[2,22], meanDataLMy[3,22], meanDataLMy[4,22]),
                               'hand_deviation_l'=c(meanDataLMy[1,23], meanDataLMy[2,23], meanDataLMy[3,23], meanDataLMy[4,23]),
                               'hand_flex_l'=c(meanDataLMy[1,24], meanDataLMy[2,24], meanDataLMy[3,24], meanDataLMy[4,24]),
...
land.means.z <- structure(list('pelvis'=c(meanDataLMz[1,1], meanDataLMz[2,1], meanDataLMz[3,1], meanDataLMz[4,1]),
                               ...
                               'foot_flex_r'=c(meanDataLMz[1,4], meanDataLMz[2,4], meanDataLMz[3,4], meanDataLMz[4,4]),
                               ...
                               'foot_flex_l'=c(meanDataLMz[1,9], meanDataLMz[2,9], meanDataLMz[3,9], meanDataLMz[4,9]),
                               ...
                               'elbow_rot_r'=c(meanDataLMz[1,16], meanDataLMz[2,16], meanDataLMz[3,16], meanDataLMz[4,16]),
                               'hand_deviation_r'=c(meanDataLMz[1,17], meanDataLMz[2,17], meanDataLMz[3,17], meanDataLMz[4,17]),
                               'hand_flex_r'=c(meanDataLMz[1,18], meanDataLMz[2,18], meanDataLMz[3,18], meanDataLMz[4,18]),
                               ...
                               'elbow_rot_l'=c(meanDataLMz[1,22], meanDataLMz[2,22], meanDataLMz[3,22], meanDataLMz[4,22]),
                               'hand_deviation_l'=c(meanDataLMz[1,23], meanDataLMz[2,23], meanDataLMz[3,23], meanDataLMz[4,23]),
                               'hand_flex_l'=c(meanDataLMz[1,24], meanDataLMz[2,24], meanDataLMz[3,24], meanDataLMz[4,24]),
...
land.means.xx <- structure(list('pelvis'=c(meanDataAMx[1,1], meanDataAMx[2,1], meanDataAMx[3,1], meanDataAMx[4,1]),
                                ...
                                'foot_flex_r'=c(meanDataAMx[1,4], meanDataAMx[2,4], meanDataAMx[3,4], meanDataAMx[4,4]),
                                ...
                                'foot_flex_l'=c(meanDataAMx[1,9], meanDataAMx[2,9], meanDataAMx[3,9], meanDataAMx[4,9]),
                                ...
                                'elbow_rot_r'=c(meanDataAMx[1,16], meanDataAMx[2,16], meanDataAMx[3,16], meanDataAMx[4,16]),
                                'hand_deviation_r'=c(meanDataAMx[1,17], meanDataAMx[2,17], meanDataAMx[3,17], meanDataAMx[4,17]),
                                'hand_flex_r'=c(meanDataAMx[1,18], meanDataAMx[2,18], meanDataAMx[3,18], meanDataAMx[4,18]),
                                ...
                                'elbow_rot_l'=c(meanDataAMx[1,22], meanDataAMx[2,22], meanDataAMx[3,22], meanDataAMx[4,22]),
                                'hand_deviation_l'=c(meanDataAMx[1,23], meanDataAMx[2,23], meanDataAMx[3,23], meanDataAMx[4,23]),
                                'hand_flex_l'=c(meanDataAMx[1,24], meanDataAMx[2,24], meanDataAMx[3,24], meanDataAMx[4,24]),
...
land.means.yy <- structure(list('pelvis'=c(meanDataAMy[1,1], meanDataAMy[2,1], meanDataAMy[3,1], meanDataAMy[4,1]),
                                ...
                                'foot_flex_r'=c(meanDataAMy[1,4], meanDataAMy[2,4], meanDataAMy[3,4], meanDataAMy[4,4]),
                                ...
                                'foot_flex_l'=c(meanDataAMy[1,9], meanDataAMy[2,9], meanDataAMy[3,9], meanDataAMy[4,9]),
                                ...
                                'elbow_rot_r'=c(meanDataAMy[1,16], meanDataAMy[2,16], meanDataAMy[3,16], meanDataAMy[4,16]),
                                'hand_deviation_r'=c(meanDataAMy[1,17], meanDataAMy[2,17], meanDataAMy[3,17], meanDataAMy[4,17]),
                                'hand_flex_r'=c(meanDataAMy[1,18], meanDataAMy[2,18], meanDataAMy[3,18], meanDataAMy[4,18]),
                                ...
                                'elbow_rot_l'=c(meanDataAMy[1,22], meanDataAMy[2,22], meanDataAMy[3,22], meanDataAMy[4,22]),
                                'hand_deviation_l'=c(meanDataAMy[1,23], meanDataAMy[2,23], meanDataAMy[3,23], meanDataAMy[4,23]),
                                'hand_flex_l'=c(meanDataAMy[1,24], meanDataAMy[2,24], meanDataAMy[3,24], meanDataAMy[4,24]),
...
land.means.zz <- structure(list('pelvis'=c(meanDataAMz[1,1], meanDataAMz[2,1], meanDataAMz[3,1], meanDataAMz[4,1]),
                                ...
                                'foot_flex_r'=c(meanDataAMz[1,4], meanDataAMz[2,4], meanDataAMz[3,4], meanDataAMz[4,4]),
                                ...
                                'foot_flex_l'=c(meanDataAMz[1,9], meanDataAMz[2,9], meanDataAMz[3,9], meanDataAMz[4,9]),
                                ...
                                'elbow_rot_r'=c(meanDataAMz[1,16], meanDataAMz[2,16], meanDataAMz[3,16], meanDataAMz[4,16]),
                                'hand_deviation_r'=c(meanDataAMz[1,17], meanDataAMz[2,17], meanDataAMz[3,17], meanDataAMz[4,17]),
                                'hand_flex_r'=c(meanDataAMz[1,18], meanDataAMz[2,18], meanDataAMz[3,18], meanDataAMz[4,18]),
                                ...
                                'elbow_rot_l'=c(meanDataAMz[1,22], meanDataAMz[2,22], meanDataAMz[3,22], meanDataAMz[4,22]),
                                'hand_deviation_l'=c(meanDataAMz[1,23], meanDataAMz[2,23], meanDataAMz[3,23], meanDataAMz[4,23]),
                                'hand_flex_l'=c(meanDataAMz[1,24], meanDataAMz[2,24], meanDataAMz[3,24], meanDataAMz[4,24]),
...
land.std.x <- structure(list('pelvis'=c(stdDataLMx[1,1], stdDataLMx[2,1], stdDataLMx[3,1], stdDataLMx[4,1]),
                             ...
                             'foot_flex_r'=c(stdDataLMx[1,4], stdDataLMx[2,4], stdDataLMx[3,4], stdDataLMx[4,4]),
                             ...
                             'foot_flex_l'=c(stdDataLMx[1,9], stdDataLMx[2,9], stdDataLMx[3,9], stdDataLMx[4,9]),
                             ...
                             'elbow_rot_r'=c(stdDataLMx[1,16], stdDataLMx[2,16], stdDataLMx[3,16], stdDataLMx[4,16]),
                             'hand_deviation_r'=c(stdDataLMx[1,17], stdDataLMx[2,17], stdDataLMx[3,17], stdDataLMx[4,17]),
                             'hand_flex_r'=c(stdDataLMx[1,18], stdDataLMx[2,18], stdDataLMx[3,18], stdDataLMx[4,18]),
                             ...
                             'elbow_rot_l'=c(stdDataLMx[1,22], stdDataLMx[2,22], stdDataLMx[3,22], stdDataLMx[4,22]),
                             'hand_deviation_l'=c(stdDataLMx[1,23], stdDataLMx[2,23], stdDataLMx[3,23], stdDataLMx[4,23]),
                             'hand_flex_l'=c(stdDataLMx[1,24], stdDataLMx[2,24], stdDataLMx[3,24], stdDataLMx[4,24]),
...
land.std.y <- structure(list('pelvis'=c(stdDataLMy[1,1], stdDataLMy[2,1], stdDataLMy[3,1], stdDataLMy[4,1]),
                             ...
                             'foot_flex_r'=c(stdDataLMy[1,4], stdDataLMy[2,4], stdDataLMy[3,4], stdDataLMy[4,4]),
                             ...
                             'foot_flex_l'=c(stdDataLMy[1,9], stdDataLMy[2,9], stdDataLMy[3,9], stdDataLMy[4,9]),
                             ...
                             'elbow_rot_r'=c(stdDataLMy[1,16], stdDataLMy[2,16], stdDataLMy[3,16], stdDataLMy[4,16]),
                             'hand_deviation_r'=c(stdDataLMy[1,17], stdDataLMy[2,17], stdDataLMy[3,17], stdDataLMy[4,17]),
                             'hand_flex_r'=c(stdDataLMy[1,18], stdDataLMy[2,18], stdDataLMy[3,18], stdDataLMy[4,18]),
                             ...
                             'elbow_rot_l'=c(stdDataLMy[1,22], stdDataLMy[2,22], stdDataLMy[3,22], stdDataLMy[4,22]),
                             'hand_deviation_l'=c(stdDataLMy[1,23], stdDataLMy[2,23], stdDataLMy[3,23], stdDataLMy[4,23]),
                             'hand_flex_l'=c(stdDataLMy[1,24], stdDataLMy[2,24], stdDataLMy[3,24], stdDataLMy[4,24]),
...
land.std.z <- structure(list('pelvis'=c(stdDataLMz[1,1], stdDataLMz[2,1], stdDataLMz[3,1], stdDataLMz[4,1]),
                             ...
                             'foot_flex_r'=c(stdDataLMz[1,4], stdDataLMz[2,4], stdDataLMz[3,4], stdDataLMz[4,4]),
                             ...
                             'foot_flex_l'=c(stdDataLMz[1,9], stdDataLMz[2,9], stdDataLMz[3,9], stdDataLMz[4,9]),
                             ...
                             'elbow_rot_r'=c(stdDataLMz[1,16], stdDataLMz[2,16], stdDataLMz[3,16], stdDataLMz[4,16]),
                             'hand_deviation_r'=c(stdDataLMz[1,17], stdDataLMz[2,17], stdDataLMz[3,17], stdDataLMz[4,17]),
                             'hand_flex_r'=c(stdDataLMz[1,18], stdDataLMz[2,18], stdDataLMz[3,18], stdDataLMz[4,18]),
                             ...
                             'elbow_rot_l'=c(stdDataLMz[1,22], stdDataLMz[2,22], stdDataLMz[3,22], stdDataLMz[4,22]),
                             'hand_deviation_l'=c(stdDataLMz[1,23], stdDataLMz[2,23], stdDataLMz[3,23], stdDataLMz[4,23]),
                             'hand_flex_l'=c(stdDataLMz[1,24], stdDataLMz[2,24], stdDataLMz[3,24], stdDataLMz[4,24]),
...
#'11 toes_l','12 back','13 head','14 arm_r','15 elbow_r','16 elbow_rot_r','17 hand_deviation_r','18 hand_flex_r','19 fingers_r',
#'20 arm_l','21 elbow_l','22 elbow_rot_l','23 hand_deviation_l','24 hand_flex_l','25 fingers_l')

# contribute: pelvis, thighs, legs, back, head
simp_names = list('5%','20%','40%','100%')
landing.means.xx <- structure(list(
  '5%'= c(meanDataAMx[1,2], meanDataAMx[1,7], 
          meanDataAMx[1,3], meanDataAMx[1,8], 
          meanDataAMx[1,4]+meanDataAMx[1,5], meanDataAMx[1,9]+meanDataAMx[1,10], 
          meanDataAMx[1,6], meanDataAMx[1,11], 
          meanDataAMx[1,14], meanDataAMx[1,20], 
          meanDataAMx[1,15]+meanDataAMx[1,16], meanDataAMx[1,21]+meanDataAMx[1,22], 
          meanDataAMx[1,17]+meanDataAMx[1,18]+meanDataAMx[1,19], meanDataAMx[1,23]+meanDataAMx[1,24]+meanDataAMx[1,25]),
  '20%' =c(meanDataAMx[2,2], meanDataAMx[2,7], 
           meanDataAMx[2,3], meanDataAMx[2,8], 
           meanDataAMx[2,4]+meanDataAMx[2,5], meanDataAMx[2,9]+meanDataAMx[2,10], 
           meanDataAMx[1,6], meanDataAMx[1,11], 
           meanDataAMx[2,14], meanDataAMx[2,20], 
           meanDataAMx[2,15]+meanDataAMx[2,16], meanDataAMx[2,21]+meanDataAMx[2,22], 
           meanDataAMx[2,17]+meanDataAMx[2,18]+meanDataAMx[2,19], meanDataAMx[2,23]+meanDataAMx[2,24]+meanDataAMx[2,25]),
  '40%' = c(meanDataAMx[3,2], meanDataAMx[3,7], 
            meanDataAMx[3,3], meanDataAMx[3,8], 
            meanDataAMx[3,4]+meanDataAMx[3,5], meanDataAMx[3,9]+meanDataAMx[3,10], 
            meanDataAMx[1,6], meanDataAMx[1,11], 
            meanDataAMx[3,14], meanDataAMx[3,20], 
            meanDataAMx[3,15]+meanDataAMx[3,16], 
            meanDataAMx[3,21]+meanDataAMx[3,22], 
            meanDataAMx[3,17]+meanDataAMx[3,18]+meanDataAMx[3,19], 
            meanDataAMx[3,23]+meanDataAMx[3,24]+meanDataAMx[3,25]),
  '100%' = c(meanDataAMx[4,2], meanDataAMx[4,7], 
             meanDataAMx[4,3], meanDataAMx[4,8], 
             meanDataAMx[4,4]+meanDataAMx[4,5], meanDataAMx[4,9]+meanDataAMx[4,10], 
             meanDataAMx[1,6], meanDataAMx[1,11], 
             meanDataAMx[4,14], meanDataAMx[4,20], 
             meanDataAMx[4,15]+meanDataAMx[4,16], meanDataAMx[4,21]+meanDataAMx[4,22], 
             meanDataAMx[4,17]+meanDataAMx[4,18]+meanDataAMx[4,19], meanDataAMx[4,23]+meanDataAMx[4,24]+meanDataAMx[4,25])
), 
.Names = simp_names, 
...
landing.stds.xx <- structure(list(
  '5%'= c(stdDataAMx[1,2], stdDataAMx[1,7], 
          stdDataAMx[1,3], stdDataAMx[1,8], 
          (stdDataAMx[1,4]+stdDataAMx[1,5])/2, (stdDataAMx[1,9]+stdDataAMx[1,10])/2, 
          stdDataAMx[1,6], stdDataAMx[1,11], 
          stdDataAMx[1,14], stdDataAMx[1,20], 
          (stdDataAMx[1,15]+stdDataAMx[1,16])/2, (stdDataAMx[1,21]+stdDataAMx[1,22])/2, 
          (stdDataAMx[1,17]+stdDataAMx[1,18]+stdDataAMx[1,19])/3, (stdDataAMx[1,23]+stdDataAMx[1,24]+stdDataAMx[1,25])/3),
  '20%' =c(stdDataAMx[2,2], stdDataAMx[2,7], 
           stdDataAMx[2,3], stdDataAMx[2,8], 
           (stdDataAMx[2,4]+stdDataAMx[2,5])/2, (stdDataAMx[2,9]+stdDataAMx[2,10])/2, 
           stdDataAMx[1,6], stdDataAMx[1,11], 
           stdDataAMx[2,14], stdDataAMx[2,20], 
           (stdDataAMx[2,15]+stdDataAMx[2,16])/2, (stdDataAMx[2,21]+stdDataAMx[2,22])/2, 
           (stdDataAMx[2,17]+stdDataAMx[2,18]+stdDataAMx[2,19])/3, (stdDataAMx[2,23]+stdDataAMx[2,24]+stdDataAMx[2,25])/3),
  '40%' = c(stdDataAMx[3,2], stdDataAMx[3,7], 
            stdDataAMx[3,3], stdDataAMx[3,8], 
            (stdDataAMx[3,4]+stdDataAMx[3,5])/2, (stdDataAMx[3,9]+stdDataAMx[3,10])/2, 
            stdDataAMx[1,6], stdDataAMx[1,11], 
            stdDataAMx[3,14], stdDataAMx[3,20], 
            stdDataAMx[3,15]+stdDataAMx[3,16], 
            stdDataAMx[3,21]+stdDataAMx[3,22], 
            (stdDataAMx[3,17]+stdDataAMx[3,18]+stdDataAMx[3,19])/3, 
            (stdDataAMx[3,23]+stdDataAMx[3,24]+stdDataAMx[3,25])/3),
  '100%' = c(stdDataAMx[4,2], stdDataAMx[4,7], 
             stdDataAMx[4,3], stdDataAMx[4,8], 
             (stdDataAMx[4,4]+stdDataAMx[4,5])/2, (stdDataAMx[4,9]+stdDataAMx[4,10])/2, 
             stdDataAMx[1,6], stdDataAMx[1,11], 
             stdDataAMx[4,14], stdDataAMx[4,20], 
             (stdDataAMx[4,15]+stdDataAMx[4,16])/2, (stdDataAMx[4,21]+stdDataAMx[4,22])/2, 
             (stdDataAMx[4,17]+stdDataAMx[4,18]+stdDataAMx[4,19])/3, (stdDataAMx[4,23]+stdDataAMx[4,24]+stdDataAMx[4,25])/3)
), 
.Names = simp_names, 
class = "data.frame", row.names = c(NA, -14L))
...
landing.ci.xx <- structure(list(
  '5%'= c(k*stdDataAMx[1,2], k*stdDataAMx[1,7], 
          k*stdDataAMx[1,3], k*stdDataAMx[1,8], 
          k*stdDataAMx[1,4]+k*stdDataAMx[1,5], k*stdDataAMx[1,9]+k*stdDataAMx[1,10], 
          k*stdDataAMx[1,6], k*stdDataAMx[1,11], 
          k*stdDataAMx[1,14], k*stdDataAMx[1,20], 
          k*stdDataAMx[1,15]+k*stdDataAMx[1,16], k*stdDataAMx[1,21]+k*stdDataAMx[1,22], 
          k*stdDataAMx[1,17]+k*stdDataAMx[1,18]+k*stdDataAMx[1,19], k*stdDataAMx[1,23]+k*stdDataAMx[1,24]+k*stdDataAMx[1,25]),
  '20%' =c(k*stdDataAMx[2,2], k*stdDataAMx[2,7], 
           k*stdDataAMx[2,3], k*stdDataAMx[2,8], 
           k*stdDataAMx[2,4]+k*stdDataAMx[2,5], k*stdDataAMx[2,9]+k*stdDataAMx[2,10], 
           k*stdDataAMx[1,6], k*stdDataAMx[1,11], 
           k*stdDataAMx[2,14], k*stdDataAMx[2,20], 
           k*stdDataAMx[2,15]+k*stdDataAMx[2,16], k*stdDataAMx[2,21]+k*stdDataAMx[2,22], 
           k*stdDataAMx[2,17]+k*stdDataAMx[2,18]+k*stdDataAMx[2,19], k*stdDataAMx[2,23]+k*stdDataAMx[2,24]+k*stdDataAMx[2,25]),
  '40%' = c(k*stdDataAMx[3,2], k*stdDataAMx[3,7], 
            k*stdDataAMx[3,3], k*stdDataAMx[3,8], 
            k*stdDataAMx[3,4]+k*stdDataAMx[3,5], k*stdDataAMx[3,9]+k*stdDataAMx[3,10], 
            k*stdDataAMx[1,6], k*stdDataAMx[1,11], 
            k*stdDataAMx[3,14], k*stdDataAMx[3,20], 
            k*stdDataAMx[3,15]+k*stdDataAMx[3,16], 
            k*stdDataAMx[3,21]+k*stdDataAMx[3,22], 
            k*stdDataAMx[3,17]+k*stdDataAMx[3,18]+k*stdDataAMx[3,19], 
            k*stdDataAMx[3,23]+k*stdDataAMx[3,24]+k*stdDataAMx[3,25]),
  '100%' = c(k*stdDataAMx[4,2], k*stdDataAMx[4,7], 
             k*stdDataAMx[4,3], k*stdDataAMx[4,8], 
             k*stdDataAMx[4,4]+k*stdDataAMx[4,5], k*stdDataAMx[4,9]+k*stdDataAMx[4,10], 
             k*stdDataAMx[1,6], k*stdDataAMx[1,11], 
             k*stdDataAMx[4,14], k*stdDataAMx[4,20], 
             k*stdDataAMx[4,15]+k*stdDataAMx[4,16], k*stdDataAMx[4,21]+k*stdDataAMx[4,22], 
             k*stdDataAMx[4,17]+k*stdDataAMx[4,18]+k*stdDataAMx[4,19], k*stdDataAMx[4,23]+k*stdDataAMx[4,24]+k*stdDataAMx[4,25])
  ), 
  .Names = simp_names, 
  class = "data.frame", row.names = c(NA, -14L))
...
landing.means.xx <- structure(list(
  '5%'= c(lower_limbs1, meanDataAMx[1,1], meanDataAMx[1,12], meanDataAMx[1,13], upper_limbs1),
  '20%' =c(lower_limbs2, meanDataAMx[2,1], meanDataAMx[2,12], meanDataAMx[2,13], upper_limbs2),
  '40%' = c(lower_limbs3, meanDataAMx[3,1], meanDataAMx[3,12], meanDataAMx[3,13], upper_limbs3),
  '100%' = c(lower_limbs4, meanDataAMx[4,1], meanDataAMx[4,12], meanDataAMx[4,13], upper_limbs4)
), 
.Names = simp_names, 
...
barx = barplot(as.matrix(-landing.means.xx), 
               ...
               col=colors,
               legend = headers,  
               las=2, cex.names = 1, beside=TRUE,args.legend = list(x=25,y=0.12,horiz=FALSE, ncol=1)) #beside=TRUE,xlab="joint",main="Landing Angular Momentum in Sagittal Plane",
rm(op)
