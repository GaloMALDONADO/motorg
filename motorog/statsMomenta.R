...
jump.means <- structure(list('pelvis'=c(meanDataLM[1,1], meanDataLM[2,1], meanDataLM[3,1], meanDataLM[4,1]),
                             'thigh_r'=c(meanDataLM[1,2], meanDataLM[2,2], meanDataLM[3,2], meanDataLM[4,2]),
                             'leg_r'=c(meanDataLM[1,3], meanDataLM[2,3], meanDataLM[3,3], meanDataLM[4,3]),
                             'thigh_l'=c(meanDataLM[1,7], meanDataLM[2,7], meanDataLM[3,7], meanDataLM[4,7]),
                             'leg_l'=c(meanDataLM[1,8], meanDataLM[2,8], meanDataLM[3,8], meanDataLM[4,8]),
...
jump.stds <- structure(list('pelvis'=c(stdDataLM[1,1], stdDataLM[2,1], stdDataLM[3,1], stdDataLM[4,1]),
                            'thigh_r'=c(stdDataLM[1,2], stdDataLM[2,2], stdDataLM[3,2], stdDataLM[4,2]),
                            'leg_r'=c(stdDataLM[1,3], stdDataLM[2,3], stdDataLM[3,3], stdDataLM[4,3]),
                            'thigh_l'=c(stdDataLM[1,7], stdDataLM[2,7], stdDataLM[3,7], stdDataLM[4,7]),
                            'leg_l'=c(stdDataLM[1,8], stdDataLM[2,8], stdDataLM[3,8], stdDataLM[4,8]),
...
jump.ci <- structure(list('pelvis'=c(t*stdDataLM[1,1]/sqrt(nparticipants), t*stdDataLM[2,1]/sqrt(nparticipants), t*stdDataLM[3,1]/sqrt(nparticipants), t*stdDataLM[4,1]/sqrt(nparticipants)),
                          'thigh_r'=c(t*stdDataLM[1,2]/sqrt(nparticipants), t*stdDataLM[2,2]/sqrt(nparticipants), t*stdDataLM[3,2]/sqrt(nparticipants), t*stdDataLM[4,2]/sqrt(nparticipants)),
                          'leg_r'=c(t*stdDataLM[1,3]/sqrt(nparticipants), t*stdDataLM[2,3]/sqrt(nparticipants), t*stdDataLM[3,3]/sqrt(nparticipants), t*stdDataLM[4,3]/sqrt(nparticipants)),
                          'thigh_l'=c(t*stdDataLM[1,7]/sqrt(nparticipants), t*stdDataLM[2,7]/sqrt(nparticipants), t*stdDataLM[3,7]/sqrt(nparticipants), t*stdDataLM[4,7]/sqrt(nparticipants)),
                          'leg_l'=c(t*stdDataLM[1,8]/sqrt(nparticipants), t*stdDataLM[2,8]/sqrt(nparticipants), t*stdDataLM[3,8]/sqrt(nparticipants), t*stdDataLM[4,8]/sqrt(nparticipants)),
