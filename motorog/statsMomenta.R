...
# ---------------------- Read the data -----------------------------------
pathName = paste(p,'TableMomentaJumpLinMomAP.csv',sep="")
...
pathName = paste(p,'TableMomentaJumpLinMomV.csv',sep="")
...
pathName = paste(p,'TableMomentaJumpAngMom.csv',sep="")
...
pathName = paste(p,'std/JumpLMy.csv',sep="")
...
pathName = paste(p,'std/JumpAMy.csv',sep="")
stdDataAMy = read.csv(pathName, header = FALSE, col.names = names)
pathName = paste(p,'std/JumpAMz.csv',sep="")
